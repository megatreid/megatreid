...
$sheet->setCellValue('F7', 'Дата принятия в работу');
//$sheet->mergeCells('G6:G7');
$sheet->setCellValue('G7', 'Город');
//$sheet->mergeCells('H6:H7');
$sheet->setCellValue('H7', 'Адрес');
//$sheet->mergeCells('I6:I7');
$sheet->setCellValue('I7', 'Задача');
//$sheet->mergeCells('J6:J7');
$sheet->setCellValue('J7', 'Решение');
//$sheet->mergeCells('K6:K7');
$sheet->setCellValue('K7', 'Статус платежа');
//$sheet->mergeCells('L6:L7');
$sheet->setCellValue('L7', 'Дата платежа');
//$sheet->mergeCells('M6:M7');
$sheet->setCellValue('M7', 'Номер счета');
$sheet->mergeCells('N6:Q6');
$sheet->setCellValue('N6', 'Расходы по заявке');
$sheet->setCellValue('N7', 'Стоимость');
$sheet->setCellValue('O7', 'Смета');
$sheet->setCellValue('P7', 'Доставка');
