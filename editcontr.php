...
/* ------------------------------------------------------------------------------------------------- */
		if(!empty($passport) AND (mb_strlen($passport)>250))
		{
		...
		<p style = "font-size: 8pt">Поля, отмеченные звездочкой, являются обязательными</p>
			<table>
				...
				<tr>
					...
					<td>
					<textarea name="comment" maxlength="100" cols="32" title = "Максимальное количество символов 100" rows="5"><?=$comment_edit?></textarea>
					</td>
				</tr>
			</table>
