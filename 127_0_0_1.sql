...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Мар 23 2019 г., 01:05
...
(12, 3159, 3563, 3612, 'Компас', 0, '456456', 2, '12345678912345678912', 'Есть', 'ООО', 'Без НДС', 'Иванов Петр Сергеевич', '', '+7920-547-89-54', '', '', '', ''),
...
(16, 3159, 3282, 3290, 'Волков А.В.', 0, '', 2, '', 'Есть', 'ИП', 'С НДС', 'Волков Алексей Витальевич', '', '+79208789621', '', '', '', '');
...
(79, '45645644', 2019, 1, 17, '2019-01-28 19:42:22', 'Подключить принтер', 'Подключили принтер', 'Кабель USB (500 р.)', 0, 0, 0, 0, 0, 500, 1000, '', '2019-03-20 02:18:13', 1, 0, 12, 0, 0, 800, '', 400, '', '0000-00-00', 0, '', '', 0, '', 0, '', '0000-00-00', 0, ''),
...
(81, '454223', 2019, 2, 14, '2019-02-10 00:38:33', 'Не загружается компьютер у кассира', '', '', 0, 0, 0, 0, 0, 0, 0, '', '2019-03-21 01:01:02', 1, 1, 0, 0, 0, 0, '', 0, '', '0000-00-00', 0, '', '', 0, '', 0, '', '0000-00-00', 0, ''),
...
(5, 'petr', '2b93067e90cdd4b261179e0cfc28a6a7', 'Петров', 'Петр', 'Петрович', 'wrew@fwef.ru', '+7(987)456-32-14', 3),
...
--
ALTER TABLE `tickets`
  MODIFY `id_ticket` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=84;
--
