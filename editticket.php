...
$ticket_number_edit = trim(filter_input(INPUT_POST, 'ticket_number'));
$year_edit = trim(filter_input(INPUT_POST, 'year'));
$month_edit = trim(filter_input(INPUT_POST, 'month'));
//$ticket_date = trim(filter_input(INPUT_POST, 'ticket_date'));
$ticket_task_edit = trim(filter_input(INPUT_POST, 'ticket_task'));
$ticket_solution_edit = trim(filter_input(INPUT_POST, 'ticket_solution'));
$ticket_material_edit = trim(filter_input(INPUT_POST, 'ticket_material'));
$ticket_status_edit = trim(filter_input(INPUT_POST, 'ticket_status'));
$ticket_sla_edit = trim(filter_input(INPUT_POST, 'ticket_sla'));
$work_type_edit = trim(filter_input(INPUT_POST, 'work_type'));
//$cost_incident = trim(filter_input(INPUT_POST, 'cost_incident'));
$hours_edit = trim(filter_input(INPUT_POST, 'hours'));
$cost_smeta_edit = trim(filter_input(INPUT_POST, 'cost_smeta'));
$cost_material_edit = trim(filter_input(INPUT_POST, 'cost_material'));
$cost_transport_edit = trim(filter_input(INPUT_POST, 'cost_transport'));
$comment_edit = trim(filter_input(INPUT_POST, 'comment'));
//$last_edit_datetime = trim(filter_input(INPUT_POST, 'last_edit_datetime'));
$last_edit_user_id_edit = trim(filter_input(INPUT_POST, 'last_edit_user_id'));
$implementer_edit = trim(filter_input(INPUT_POST, 'implementer'));
$id_contractor_edit = trim(filter_input(INPUT_POST, 'id_contractor'));
$contr_cost_work_edit = trim(filter_input(INPUT_POST, 'contr_cost_work'));
$contr_cost_smeta_edit = trim(filter_input(INPUT_POST, 'contr_cost_smeta'));
$contr_cost_transport_edit = trim(filter_input(INPUT_POST, 'contr_cost_transport'));
$contr_material_edit = trim(filter_input(INPUT_POST, 'contr_material'));
$contr_cost_material_edit = trim(filter_input(INPUT_POST, 'contr_cost_material'));
$contr_account_number_edit = trim(filter_input(INPUT_POST, 'contr_account_number'));
$contr_date_payment_edit = trim(filter_input(INPUT_POST, 'contr_date_payment'));
//echo $contr_date_payment_edit;
$contr_payment_status_edit = trim(filter_input(INPUT_POST, 'contr_payment_status'));
$contr_comment_edit = trim(filter_input(INPUT_POST, 'contr_comment'));
$supplier_edit = trim(filter_input(INPUT_POST, 'supplier'));
$supplier_cost_work_edit = trim(filter_input(INPUT_POST, 'supplier_cost_work'));
$supplier_contr_material_edit = trim(filter_input(INPUT_POST, 'supplier_contr_material'));
$supplier_cost_material_edit = trim(filter_input(INPUT_POST, 'supplier_cost_material'));
$supplier_account_number_edit = trim(filter_input(INPUT_POST, 'supplier_account_number'));
$supplier_date_payment_edit = trim(filter_input(INPUT_POST, 'supplier_date_payment'));
$supplier_payment_status_edit = trim(filter_input(INPUT_POST, 'supplier_payment_status'));
$supplier_comment_edit = trim(filter_input(INPUT_POST, 'supplier_comment'));
